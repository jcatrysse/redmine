...
commit_51: 0214f3ecc
geoxyz: live
geoxyz_commit: 198cbfb63 + 47eec6f1d
...
commits `198cbfb63` + `47eec6f1d` op `7.0-stable-GEOxyz`, dossier bijgewerkt,
...
**bereik van 0 tot en met 10**: daarbuiten weigert het formulier de waarde met de
gewone Redmine-foutmelding, en `0` betekent wat het zegt — er mag geen nieuw
blok met een eigen zoekopdracht meer bij.

...
- **Reviewed:** `patch/revision-branches` at `53faa9a0f` and GEOxyz, freshly fetched
- **Dossier read:** `docs/features/revision-branches/dossier.md` — yes
- **Status read:** `docs/features/revision-branches/status.md` including settled trade-offs — yes
...
Command injection, XSS, encoding, regex/glob input, subprocess bounds, permissions and settings UX were rechecked; no new confirmed defect.

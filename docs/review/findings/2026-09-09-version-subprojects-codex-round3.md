...
- **Reviewed:** `patch/version-subprojects` at `6ad109efe` and GEOxyz through `73157aee5`, freshly fetched
- **Dossier read:** `docs/features/version-subprojects/dossier.md` — yes
- **Status read:** `docs/features/version-subprojects/status.md` including settled trade-offs — yes
...
The project-tree narrowing and regression test now exist on both sides. Visibility, arbitrary ids, archived projects, query cost and dynamic-filter UX were rechecked; no new defect.
